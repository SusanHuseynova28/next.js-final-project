      ...
      <div className="flex flex-col lg:flex-row justify-between items-center max-w-6xl mx-auto gap-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white text-black p-6 rounded-lg shadow-md w-full lg:w-[18rem] h-auto lg:h-[30rem]">
            <h3 className="text-2xl lg:text-3xl font-bold">Start your project from your pocket.</h3>
          ...
          <div className="bg-white text-black p-6 rounded-lg shadow-md w-full lg:w-[18rem] h-auto lg:h-[30rem]">
            <h3 className="text-2xl lg:text-3xl font-bold">Available on all responsive devices.</h3>
            <div>
              <img
        ...
        <div className="max-w-md mt-8 lg:mt-0 lg:ml-12">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold mt-4">Seamless productivity with our new app</h2>
