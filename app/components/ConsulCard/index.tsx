...
export default function ConsulCard() {
  return (
    <section className="bg-white mx-auto flex justify-center items-center w-full lg:w-[80%] h-auto lg:h-[40rem] py-12 lg:py-0">
      <div className="container px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="lg:pl-24">
          <p className="text-blue-600 uppercase tracking-widest text-xs mb-2">
            Consulting Excellence
          </p>
          <h2 className="text-2xl lg:text-5xl w-full lg:w-[24rem] font-bold text-gray-900 mb-6">
            Best pathway to our clients.
          </h2>
          <p className="text-gray-600 mb-8 w-full lg:w-[23rem]">
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-center">
          <div className="bg-[#F3F6FD] p-6 h-auto lg:h-[9rem] w-full lg:w-[25rem] rounded-lg shadow-sm lg:mt-32">
            ...
            <div className="space-y-12">
              <div className="flex items-center space-x-6">
                ...
                <div className="w-full">
                  <div className="bg-[#F3F6FD] p-6 rounded-lg shadow-sm w-full lg:w-[14rem]">
